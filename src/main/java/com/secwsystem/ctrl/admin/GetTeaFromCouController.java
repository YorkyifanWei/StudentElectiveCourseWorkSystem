...
public class GetTeaFromCouController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        GetTeasFromCouController controller = (GetTeasFromCouController) Context.controllers.get(GetTeasFromCouController.class.getSimpleName());
