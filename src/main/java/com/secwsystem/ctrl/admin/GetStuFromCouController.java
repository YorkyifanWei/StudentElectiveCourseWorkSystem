...
public class GetStuFromCouController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        GetStusFromCouController controller = (GetStusFromCouController) Context.controllers.get(GetStusFromCouController.class.getSimpleName());
